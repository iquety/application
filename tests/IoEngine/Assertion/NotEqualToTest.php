...
class NotEqualToTest extends AssertionCase
{
    ...
    public function validProvider(): array
    {
        ...
        $list['param decimal string 11.5 not equal to decimal 11.4'] = $this->makeAssertionItem(
    ...
    public function invalidProvider(): array
    {
        ...
        $list['param decimal string 11.5 equal to decimal 11.5'] = $this->makeAssertionItem(
            'param_decimal_string',
            11.5
        );
    ...
    public function valueAsserted(string $paramName, mixed $valueOne): void
    {
        ...
        $input->assert($paramName)->notEqualTo($valueOne);
    ...
    public function fieldDoesNotExist(string $paramName): void
    {
        ...
        $input->assert($paramName)->notEqualTo('xx');
