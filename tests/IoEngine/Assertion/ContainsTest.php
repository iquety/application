...
class ContainsTest extends AssertionCase
{
    ...
    {
        $this->setAssertionMethod('contains');
    ...
    public function validProvider(): array
    {
        ...
        $list["array contains integer 111"]  = $this->makeAssertionItem('param_array', 111);
    ...
    public function invalidProvider(): array
    {
        ...
        $list['param decimal 11.5 not contains float .5']     = $this->makeAssertionItem('param_decimal_string', .5);    // não funciona
