...
class MatchesTest extends AssertionCase
{
    ...
    public function invalidProvider(): array
    {
        ...
        $list['param boolean true not matches 0']         = $this->makeAssertionItem('param_true', '/0/');
        $list['param boolean false not matches [0-9]{2}'] = $this->makeAssertionItem('param_false', '/[0-9]{2}/');
        $list['param boolean false not matches 1']        = $this->makeAssertionItem('param_false', '/1/');
    ...
    public function fieldDoesNotExist(string $paramName): void
    {
        ...
        $input->assert($paramName)->matches('xx', 'xx');
